...
<head>
  ...
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{ asset('tmp/bower_components/jvectormap/jquery-jvectormap.css') }}">
  <!-- Date Picker -->
  <link rel="stylesheet" href="{{ asset('tmp/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="{{ asset('tmp/bower_components/bootstrap-daterangepicker/daterangepicker.css') }}">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="{{ asset('tmp/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css') }}">
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('tmp/bower_components/jquery-ui/jquery-ui.min.js') }}"></script>
...
<!-- Sparkline -->
<script src="{{ asset('tmp/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js') }}"></script>
<!-- jvectormap -->
<script src="{{ asset('tmp/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
<script src="{{ asset('tmp/plugins/jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('tmp/bower_components/jquery-knob/dist/jquery.knob.min.js') }}"></script>
<!-- daterangepicker -->
<script src="{{ asset('tmp/bower_components/moment/min/moment.min.js') }}"></script>
<script src="{{ asset('tmp/bower_components/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<!-- datepicker -->
<script src="{{ asset('tmp/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="{{ asset('tmp/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js') }}"></script>
<!-- Slimscroll -->
...
<script src="{{ asset('tmp/dist/js/pages/dashboard.js') }}"></script>
